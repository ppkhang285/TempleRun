...
#pragma warning restore 618
        ...
        {
            LuaCallCSharp = LuaGeneratorConfig.LuaCallCSharp;

            CSharpCallLua = LuaGeneratorConfig.CSharpCallLua;

            GCOptimizeList = LuaGeneratorConfig.GCOptimizeList;

            AdditionalProperties = LuaGeneratorConfig.AdditionalProperties;

            ReflectionUse = LuaGeneratorConfig.ReflectionUse;

            BlackList = LuaGeneratorConfig.BlackList;

            HotfixCfg = LuaGeneratorConfig.HotfixCfg;

            OptimizeCfg = LuaGeneratorConfig.OptimizeCfg;

            DoNotGen = LuaGeneratorConfig.DoNotGen;
